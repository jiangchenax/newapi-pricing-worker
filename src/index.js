...
// compact overview, same typography
// ============================================================
...
class HeadInjector {
  element(element) {
    element.append(
      '<style id="moss-pricing-v75-style">' +
      GLOBAL_CSS +
      '</style>',
      {
        html: true,
...
class BodyInjector {
  element(element) {
    ...
    element.append(
      '<script id="moss-pricing-v75-script">' +
      safeClientJs +
      '</script>',
      {
        html: true,
