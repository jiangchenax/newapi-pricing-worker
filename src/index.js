...
class HeadInjector {
  element(element) {
    element.append(
      '<link ' +
      'id="moss-pricing-v92-style" ' +
      'rel="stylesheet" ' +
      'href="/pricing-assets/v9.2-opaque-continuity.css">',
      {
        html: true,
      }
    );
...
class BodyInjector {
  element(element) {
    element.append(
      '<script ' +
      'id="moss-pricing-v92-script" ' +
      'defer ' +
      'src="/pricing-assets/v9.2-opaque-continuity.js">' +
      '</script>',
      {
        html: true,
      }
...
export default {
  async fetch(
    ...
    if (
      url.pathname ===
      "/pricing-assets/v9.2-opaque-continuity.css"
    ) {
      return new Response(
        GLOBAL_CSS,
        {
    ...
    if (
      url.pathname ===
      "/pricing-assets/v9.2-opaque-continuity.js"
    ) {
      return new Response(
        CLIENT_JS,
        {
