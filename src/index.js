...
// performance fixes + native dialog backdrop + model-brand logos
// ============================================================
...
class HeadInjector {
  element(element) {
    element.append(
      '<style id="moss-pricing-v73-style">' +
      GLOBAL_CSS +
      '</style>',
      {
        html: true,
...
class BodyInjector {
  element(element) {
    ...
    element.append(
      '<script id="moss-pricing-v73-script">' +
      safeClientJs +
      '</script>',
      {
        html: true,
...
export default {
  async fetch(
    ...
    return withDebugHeader(
      transformed,
      "active-v7.3-performance-modal-model-brand"
    );
  },
};
