...
class HeadInjector {
  element(element) {
    element.append(
      '<link ' +
      'id="moss-pricing-v9-style" ' +
      'rel="stylesheet" ' +
      'href="/pricing-assets/v9-clean.css">',
      {
        html: true,
      }
    );
...
class BodyInjector {
  element(element) {
    element.append(
      '<script ' +
      'id="moss-pricing-v9-script" ' +
      'defer ' +
      'src="/pricing-assets/v9-clean.js">' +
      '</script>',
      {
        html: true,
      }
