...
class HeadInjector {
  element(element) {
    element.append(
      '<link ' +
      'id="moss-pricing-v821-style" ' +
      'rel="stylesheet" ' +
      'href="/pricing-assets/v8.2.1-stable-detail.css">',
      {
        html: true,
      }
    );
...
class BodyInjector {
  element(element) {
    element.append(
      '<script ' +
      'id="moss-pricing-v821-script" ' +
      'defer ' +
      'src="/pricing-assets/v8.2.1-stable-detail.js">' +
      '</script>',
      {
        html: true,
      }
...
export default {
  async fetch(
    ...
    if (
      url.pathname ===
      "/pricing-assets/v8.2.1-stable-detail.css"
    ) {
      return new Response(
        GLOBAL_CSS,
        {
    ...
    if (
      url.pathname ===
      "/pricing-assets/v8.2.1-stable-detail.js"
    ) {
      return new Response(
        CLIENT_JS,
        {
