...
class HeadInjector {
  element(element) {
    element.append(
      '<link ' +
      'id="moss-pricing-v82-style" ' +
      'rel="stylesheet" ' +
      'href="/pricing-assets/v8.2-newapi-native.css">',
      {
        html: true,
      }
    );
...
class BodyInjector {
  element(element) {
    element.append(
      '<script ' +
      'id="moss-pricing-v82-script" ' +
      'defer ' +
      'src="/pricing-assets/v8.2-newapi-native.js">' +
      '</script>',
      {
        html: true,
      }
...
export default {
  async fetch(
    ...
    if (
      url.pathname ===
      "/pricing-assets/v8.2-newapi-native.css"
    ) {
      return new Response(
        GLOBAL_CSS,
        {
    ...
    if (
      url.pathname ===
      "/pricing-assets/v8.2-newapi-native.js"
    ) {
      return new Response(
        CLIENT_JS,
        {
