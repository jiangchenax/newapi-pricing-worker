...
// stable native-dialog centering + model-market heading UI
// ============================================================
...
class HeadInjector {
  element(element) {
    element.append(
      '<style id="moss-pricing-v74-style">' +
      GLOBAL_CSS +
      '</style>',
      {
        html: true,
...
class BodyInjector {
  element(element) {
    ...
    element.append(
      '<script id="moss-pricing-v74-script">' +
      safeClientJs +
      '</script>',
      {
        html: true,
...
export default {
  async fetch(
    ...
    return withDebugHeader(
      transformed,
      "active-v7.4-stable-dialog-market-heading"
    );
  },
};
