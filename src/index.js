...
class HeadInjector {
  element(element) {
    element.append(
      '<style id="moss-pricing-v78-style">' +
      GLOBAL_CSS +
      '</style>',
      {
        html: true,
...
class BodyInjector {
  element(element) {
    ...
    element.append(
      '<script id="moss-pricing-v78-script">' +
      safeClientJs +
      '</script>',
      {
        html: true,
...
export default {
  async fetch(
    ...
    return withDebugHeader(
      transformed,
      "active-v7.8-unified-overview-layout"
    );
  },
};
