...
// readable list + Chinese status labels + header-safe popover
// ============================================================
...
class HeadInjector {
  element(element) {
    element.append(
      '<style id="moss-pricing-v61-style">' +
      GLOBAL_CSS +
      '</style>',
      {
        html: true,
...
class BodyInjector {
  element(element) {
    ...
    element.append(
      '<script id="moss-pricing-v61-script">' +
      safeClientJs +
      '</script>',
      {
        html: true,
...
export default {
  async fetch(
    ...
    return withDebugHeader(
      transformed,
      "active-v6.1-readable-safe-popover"
    );
  },
};
