...
// content-sized overview + tab-adaptive dialog width
// ============================================================
...
class HeadInjector {
  element(element) {
    element.append(
      '<style id="moss-pricing-v77-style">' +
      GLOBAL_CSS +
      '</style>',
      {
        html: true,
...
class BodyInjector {
  element(element) {
    ...
    element.append(
      '<script id="moss-pricing-v77-script">' +
      safeClientJs +
      '</script>',
      {
        html: true,
...
export default {
  async fetch(
    ...
    return withDebugHeader(
      transformed,
      "active-v7.7-content-sized-overview"
    );
  },
};
